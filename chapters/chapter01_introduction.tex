...
The mixing matrix with mixing angles ($\theta_{12}$, $\theta_{23}$ and
...
%% The Majorana
%% phases do not appear in the neutrino oscillation.
...
%% eigenvalues correspond to the vacuum propagation Hamiltonian
%% $\left(H_0\right)$.
...
%% secondary cosmic rays at the surface, etc.
